...
const drawerClose: Ref<HTMLElement | null> = ref(null);
const router = useRouter();
const blogList: Ref<Array<string>> = ref(["如何使用vue2", "flex用法"]);
const routerToblog = (to: string) => {
  router.push({ name: "blog", params: { name: to } });
  drawerClose.value?.click();
};
const routerTohome = () => {
    ...
    <div class="drawer">
      ...
      <div class="drawer-content">
        ...
        <header class="border-b navbar">
          ...
          <div class="hidden md:block navbar-center">
            <a class="btn btn-ghost normal-case text-xl">CoffeeSwt</a>
          </div>
          <div class="navbar-end">
            <div class="dropdown dropdown-hover dropdown-bottom mx-2">
              <label tabindex="0" class="btn btn-sm"
                ...
                <span class="hidden md:inline">主题</span></label
              >
              <ul
                tabindex="0"
            ...
            <button tabindex="0" class="btn btn-sm mx-2">
              <svg
                width="21"
                height="21"
                viewBox="0 0 48 48"
              ...
              <span class="hidden md:inline">博客</span>
            </button>
            <button tabindex="0" class="btn btn-sm mx-2">
              <svg
                width="21"
      ...
      <div class="drawer-side">
        ...
        >
          ...
          <a
            class="btn btn-ghost normal-case text-base sm:text-lg"
            @click="routerTohome"
            >Coffee的网站</a
          >
